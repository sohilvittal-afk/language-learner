...
// Bypasses row-level security entirely — never expose this key or client to
// the browser. Only used server-side, and only from routes that have already
// checked the caller's role themselves (see requireRole in server.js).
...
module.exports = { getSupabaseClient, getSupabaseClientForToken, getServiceRoleClient };
